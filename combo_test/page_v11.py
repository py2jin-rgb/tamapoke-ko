...
repls = [
    ...
    ('🧪 NEW TEST · COMBO v1.0', '🎮 COMBO · GAMES 1'),
    ('③ 안정판 + 알람 + 한글 천지인</h2>', '③ 알람 + 한글 천지인 + 미니게임 한방판</h2>'),
    ('① 안정판의 수정사항과 ② 알람 v1.1을 합친 뒤, 이름변경에 <b>한글 천지인 조합 키보드</b>를 추가한 통합 시험판입니다.', '알람시계 + 한글 천지인 + stability2를 유지하면서 <b>확장형 놀이 선택화면과 새 미니게임/효과음</b>을 추가한 통합판입니다.'),
    ('manifest-combo.json?v=combo10', 'manifest-combo.json?v=games1'),
    ('<button slot="activate">⌨️ 천지인 통합판 설치</button>', '<button slot="activate">🎮 알람 + 천지인 + 게임판 설치</button>'),
    ('<div class="combowarn"><b>통합 테스트판 주의:</b> GitHub ESP32 컴파일은 성공했습니다. 하지만 천지인 터치 위치·글꼴 크기·이름 저장 후 모든 화면 표시는 아직 실기 확인 전입니다. 문제가 있으면 ① 안정판으로 즉시 돌아갈 수 있습니다. <b>Erase/초기화는 선택하지 마세요.</b></div>', '<div class="combowarn"><b>GAMES 1 테스트:</b> 기존 천지인/알람/시계 기능은 유지하고 놀이 메뉴만 확장했습니다. 새 두더지/가위바위보의 터치감과 효과음은 실기에서 계속 조정할 수 있습니다. <b>Erase/초기화는 선택하지 마세요.</b></div>'),
]
...
add = marker + (
    ...
    '<p class="ok">✓ 미니게임 전용 오리지널 8비트 효과음 12종 추가 · 알람 우선 재생</p>'
...
print('installer page updated for combo games1')
